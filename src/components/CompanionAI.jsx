...
export default function CompanionAI({ userStats, profile, onClose }) {
  ...
  // Mengambil nama dinamis dari profile database Anda
  ...
  const handleSend = async (e, customMsg = null, isFaq = false, isAllCategories = false) => {
    ...
    // Aktifkan Loading, tanpa memicu fungsi speakText agar GIF berpikir tidak rusak
    setLoading(true)
